...
void HAL_DMA_InitHookFromVendor(void) {
    /* DMA初始化函数 */
    g_dmaHost.HAL_DMA_Init = HAL_DMA_Init;
    g_dmaHost.HAL_DMA_DeInit = HAL_DMA_DeInit;
    g_dmaHost.HAL_DMA_MspInit = HAL_DMA_MspInit;
    g_dmaHost.HAL_DMA_MspDeInit = HAL_DMA_MspDeInit;
